...
public class JobSetupPointListAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "JobSetupPointListAdapto";

    private DialogJobSetupPointList dialogJobSetupPointList;
...
//        On Click Listener
    ...
    private void populateValueInSetup(PointSurvey pointSurvey){
        dialogJobSetupPointList.setPointSurveyData(pointSurvey);
        dialogJobSetupPointList.dismiss();
