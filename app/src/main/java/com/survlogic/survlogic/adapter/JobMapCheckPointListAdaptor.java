...
public class JobMapCheckPointListAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "JobSetupPointListAdapto";

    private DialogJobMapCheckPointList dialogJobMapCheckPointList;
...
//    CONSTRUCTOR!!!!!
    public JobMapCheckPointListAdaptor(Context context, ArrayList<PointSurvey> pointSurveys, DialogJobMapCheckPointList dialogJobMapCheckPointList, DecimalFormat COORDINATE_FORMATTER){
        this.pointSurveys = pointSurveys;

        mContext = context;
        this.isOccupyPoint = isOccupyPoint;
        this.dialogJobMapCheckPointList = dialogJobMapCheckPointList;
    ...
    private void populateValueInSetup(PointSurvey pointSurvey){
        dialogJobMapCheckPointList.setPointSurveyData(pointSurvey);
        dialogJobMapCheckPointList.dismiss();
