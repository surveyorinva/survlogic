...
public class ProjectGridImageAdapter extends ArrayAdapter {
    ...
    public ProjectGridImageAdapter(Context context, int layoutResource, String append, ArrayList<ProjectImages> images) {
