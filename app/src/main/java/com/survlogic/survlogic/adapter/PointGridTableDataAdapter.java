...
public class PointGridTableDataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //    CONSTRUCTOR!!!!!
    public PointGridTableDataAdapter(Context context, ArrayList<PointSurvey> pointSurvey, DecimalFormat COORDINATE_FORMATTER, JobPointsActivityListener jobPointsActivityListener){
