...
public class Card_View_Holder_Job_Mapcheck_Results extends RecyclerView.ViewHolder  {
    private static final String TAG = "Card_View_Holder_Job_Ma";
    private Context mContext;

    public TextView tvPointNumber, tvPointDesc, tvPointNorthing, tvPointEasting;
    public View mCardView;



    public Card_View_Holder_Job_Mapcheck_Results(View itemView, Context mContext) {
        super(itemView);
