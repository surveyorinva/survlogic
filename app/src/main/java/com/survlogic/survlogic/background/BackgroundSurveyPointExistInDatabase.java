...
public class BackgroundSurveyPointExistInDatabase extends AsyncTask <PointSurvey,PointSurvey,String> {

    private static final String TAG = "BackgroundSurveyPointCh";

    private Context context;

    private final DatabaseDoesPointExistFromAsyncListener mListener;
    private String DB_NAME;
    private int pointNumber;
    private boolean isPointFound = false, forASearch = false;

    public BackgroundSurveyPointExistInDatabase(Context context, String DB_NAME, DatabaseDoesPointExistFromAsyncListener listener, int pointNumber) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (mListener != null){
            Log.d(TAG, "onPostExecute: mListener Not Null");
                mListener.doesPointExist(pointNumber, isPointFound);
