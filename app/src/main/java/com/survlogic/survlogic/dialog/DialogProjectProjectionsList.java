...
public class DialogProjectProjectionsList extends DialogFragment {
    ...
    private ProjectProjectionsAdapter adapter;
    ...
    public static DialogProjectProjectionsList newInstance(String[] lstProjections) {
        Log.d(TAG, "newInstance: Starting...");
        DialogProjectProjectionsList frag = new DialogProjectProjectionsList();
        Bundle args = new Bundle();
        args.putStringArray("list",lstProjections);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        projectionList = getArguments().getStringArray("list");

        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(), R.style.DialogPointViewStyle);
        LayoutInflater inflater = getActivity().getLayoutInflater();

        View v = inflater.inflate(R.layout.dialog_projection_grid_list,null);
        builder.setView(v);
    ...
    private void initProjectionsLocal(){
        Log.d(TAG, "initProjectionsLocal: Started");

        DialogProjectProjectionsList dialogProjectProjectionsList = this;
        ProjectProjectionListener listener = (ProjectProjectionListener) getActivity();

        mRecyclerView = (RecyclerView) getDialog().findViewById(R.id.projectionListRecyclerView);
        layoutManager = new LinearLayoutManager(mContext);
        mRecyclerView.setLayoutManager(layoutManager);
        mRecyclerView.setHasFixedSize(false);

        adapter = new ProjectProjectionsAdapter(mContext,dialogProjectProjectionsList,listener,projectionList);
