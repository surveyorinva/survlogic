...
import com.survlogic.survlogic.adapter.JobInversePointListAdaptor;
...
public class DialogJobInversePointList extends DialogFragment {
    ...
    private JobInversePointListAdaptor adapter;
    ...
    public static DialogJobInversePointList newInstance(int projectId, int jobId, String databaseName, ArrayList<PointSurvey> items, boolean isFromPoint) {
        Log.d(TAG, "newInstance: Starting...");
        DialogJobInversePointList frag = new DialogJobInversePointList();
        Bundle args = new Bundle();
        args.putInt("project_id", projectId);
        args.putInt("job_id", jobId);
        args.putString("databaseName", databaseName);
        args.putBoolean("isFromPoint", isFromPoint);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        isFromPoint = getArguments().getBoolean("isFromPoint");
    ...
    private void initPointsLocal(){
        ...
        JobPointsInversePointListListener listener = (JobPointsInversePointListListener) getActivity();
        ...
        adapter = new JobInversePointListAdaptor(mContext,pointList, DialogJobInversePointList.this, COORDINATE_FORMATTER);
    ...
    public void setPointSurveyData(PointSurvey pointSurvey){
        ...
        if(isFromPoint){
            listener.onReturnValuesInverseFrom(pointSurvey);
        }else{
            listener.onReturnValuesInverseTo(pointSurvey);
        }
